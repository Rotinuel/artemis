...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed w-full px-5 lg:pr-0.5 xl:px-[8%] py-2 flex items-right justify-between z-50 ${
      ...
      >
        ...
        {/* mobile menu */}
        <ul
          className={`fixed top-0 bottom-0 right-0 w-72 z-50 h-screen bg-[#000] text-[#fff] flex flex-col gap-4 py-10 px-10 transition-transform duration-500 font-normal text-[52px] leading-[58px]
